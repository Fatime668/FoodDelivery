...
import {  signInUser, signupUser } from '../redux/slice/AuthSlice'
import { AppDispatch, RootState } from '../redux'
import { Formik } from 'formik';
import * as Yup from 'yup'
import { Auth } from '../../models/Auth'
import { signInInitialValues, signInSchema, signUpInitialValues, signUpSchema } from '../../schema/authSchema'
      ...
      {  
        ...
        <View style={styles.inputContainer}>
          <View style={styles.inputSubContainer}>
            ...
            />
           {formik.errors.username&&<Text style={{left:20,bottom:-20,position:'absolute',color:"tomato"}}>{formik.errors.email}</Text>}
